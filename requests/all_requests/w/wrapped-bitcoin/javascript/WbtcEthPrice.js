...
// Retrieve WBTC/ETH-6 price from the Binance HTTP-GET API
const binance = new Witnet.Source("https://api.binance.us/api/v3/ticker/price?symbol=WBTCETH")
  .parseJSONMap()
  .getFloat("price")
  .multiply(10 ** 6)
  .round()

// Retrieves ETH price of WBTC from the OkEx API (derived from USDT/USD exchange rate)
const okex = new Witnet.Source("https://www.okex.com/api/index/v3/WBTC-ETH/constituents")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
