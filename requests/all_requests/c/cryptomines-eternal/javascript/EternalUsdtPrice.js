...
// Retrieves ETERNAL/USDT-6 from the Hoo HTTP-GET API
    const hoo = new Witnet.Source("https://api.hoolgd.com/open/v1/tickers/market")
      ...
      .filter( 
        ...
        // matches "ETERNAL-USDT":
        new Witnet.Script([ Witnet.TYPES.MAP ])
          .getString("symbol")
          .match({ "ETERNAL-USDT": true }, false)
      )
...
// Retrieves USDT price of ETERNAL from the Gate.io API
const gateio = new Witnet.Source("https://data.gateapi.io/api2/1/ticker/eternal_usdt")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
