...
// Retrieve CFX/USDT-6 price from the Binance HTTP-GET API
const binance = new Witnet.Source("https://api.binance.us/api/v3/ticker/price?symbol=CFXUSDT")
  .parseJSONMap()
  .getFloat("price")
  .multiply(10 ** 6)
  .round()
...
// Retrieves USDT price of CFX from the OkEx API (derived from USDT/USD exchange rate)
const okex = new Witnet.Source("https://www.okex.com/api/index/v3/CFX-USDT/constituents")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
...
// Retrieves CFX/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves USDT price of CFX from the HOTBIT API
const hotbit = new Witnet.Source("https://api.hotbit.io/api/v1/market.last?market=CFXUSDT")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
