...
// Retrieves USDT price of CHE from the OkEx API (derived from USDT/USD exchange rate)
const okex = new Witnet.Source("https://www.okex.com/api/index/v3/CHE-USDT/constituents")
...
// Retrieves CHE/USDT-6 from the Hoo HTTP-GET API
