...
// Retrieves USDT price of BORING from the OkEx API (derived from USDT/USD exchange rate)
const okex = new Witnet.Source("https://www.okex.com/api/index/v3/BORING-USDT/constituents")
...
// Retrieves BORING/USDT price from the HUOBI API
