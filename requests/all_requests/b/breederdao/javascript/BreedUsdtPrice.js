...
// Retrieves BREED/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves BREED/USDT price from the HUOBI API
const huobi = new Witnet.Source("https://api.huobi.pro/market/detail/merged?symbol=breedusdt")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
