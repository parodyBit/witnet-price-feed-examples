...
// Retrieves PLU/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves PLU/USDT-6 price from the Bitmax API
...
// Retrieves PLU/USDT-6 from KUCOIN API
const kucoin = new Witnet.Source("https://api.kucoin.com/api/v1/market/orderbook/level1?symbol=PLU-USDT")
  .parseJSONMap() 
  .getMap("data")
  .getFloat("price")
  .multiply(10 ** 6)
...
// Retrieves PLU/USDT price from the HUOBI API
const huobi = new Witnet.Source("https://api.huobi.pro/market/detail/merged?symbol=pluusdt")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
