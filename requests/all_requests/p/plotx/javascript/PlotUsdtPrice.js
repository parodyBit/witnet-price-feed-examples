...
// Retrieves PLOT/USDT-6 price from the Bitmax API
...
// Retrieves PLOT/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves USDT price of PLOT from the HOTBIT API
const hotbit = new Witnet.Source("https://api.hotbit.io/api/v1/market.last?market=PLOTUSDT")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
