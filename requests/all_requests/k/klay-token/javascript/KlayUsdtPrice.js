...
const binance = new Witnet.Source("https://api.binance.us/api/v3/ticker/price?symbol=KLAYUSDT")
  .parseJSONMap()
  .getFloat("price")
  .multiply(10 ** 6)
  .round()
...
// Retrieves USDT price of KLAY from the OkEx API (derived from USDT/USD exchange rate)
const okex = new Witnet.Source("https://www.okex.com/api/index/v3/KLAY-USDT/constituents")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
...
// Retrieves USDT price of KLAY from the Gate.io API
...
// Retrieves KLAY/USDT price from the HUOBI API
const huobi = new Witnet.Source("https://api.huobi.pro/market/detail/merged?symbol=klayusdt")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
...
// Retrieves KLAY/USDT-6 from KUCOIN API
...
// Retrieve KLAY/USDT-6 price from Bittrex
const bittrex = new Witnet.Source("https://api.bittrex.com/v3/markets/KLAY-USDT/ticker")
  .parseJSONMap()
