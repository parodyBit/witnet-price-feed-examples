...
// Retrieves USDJ/USDT-6 from KUCOIN API
const kucoin = new Witnet.Source("https://api.kucoin.com/api/v1/market/orderbook/level1?symbol=USDJ-USDT")
  .parseJSONMap() 
  .getMap("data")
  .getFloat("price")
  .multiply(10 ** 6)
...
// Retrieves USDJ/USDT-6 from the Hoo HTTP-GET API
