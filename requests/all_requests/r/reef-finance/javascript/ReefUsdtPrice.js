...
// Retrieve REEF/USDT-6 price from the Binance HTTP-GET API
const binance = new Witnet.Source("https://api.binance.us/api/v3/ticker/price?symbol=REEFUSDT")
  .parseJSONMap()
  .getFloat("price")
  .multiply(10 ** 6)
  .round()

// Retrieves REEF/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves USDT price of REEF from the Gate.io API
...
// Retrieves REEF/USDT-6 from KUCOIN API
...
// Retrieves REEF/USDT price from the HUOBI API
const huobi = new Witnet.Source("https://api.huobi.pro/market/detail/merged?symbol=reefusdt")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
...
// Retrieves USDT price of REEF from the HOTBIT API
const hotbit = new Witnet.Source("https://api.hotbit.io/api/v1/market.last?market=REEFUSDT")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
