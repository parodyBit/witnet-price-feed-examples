...
// Retrieves RPL/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves USDT price of RPL from the HOTBIT API
const hotbit = new Witnet.Source("https://api.hotbit.io/api/v1/market.last?market=RPLUSDT")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
