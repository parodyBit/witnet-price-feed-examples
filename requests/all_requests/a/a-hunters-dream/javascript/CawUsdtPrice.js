...
// Retrieves CAW/USDT price from the HUOBI API
const huobi = new Witnet.Source("https://api.huobi.pro/market/detail/merged?symbol=cawusdt")
...
// Retrieves CAW/USDT-6 from the Hoo HTTP-GET API
