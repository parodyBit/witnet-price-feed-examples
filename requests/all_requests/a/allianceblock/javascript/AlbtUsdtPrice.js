...
// Retrieves ALBT/USDT-6 from KUCOIN API
const kucoin = new Witnet.Source("https://api.kucoin.com/api/v1/market/orderbook/level1?symbol=ALBT-USDT")
  .parseJSONMap() 
  .getMap("data")
  .getFloat("price")
  .multiply(10 ** 6)
...
// Retrieves ALBT/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves USDT price of ALBT from the HOTBIT API
const hotbit = new Witnet.Source("https://api.hotbit.io/api/v1/market.last?market=ALBTUSDT")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
