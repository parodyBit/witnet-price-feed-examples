...
// Retrieve FET/USDT-6 price from the Binance HTTP-GET API
const binance = new Witnet.Source("https://api.binance.us/api/v3/ticker/price?symbol=FETUSDT")
  .parseJSONMap()
  .getFloat("price")
  .multiply(10 ** 6)
  .round()

// Retrieves FET/USDT-6 price from the Bitmax API
...
// Retrieves FET/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves USDT price of FET from the Gate.io API
const gateio = new Witnet.Source("https://data.gateapi.io/api2/1/ticker/fet_usdt")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
  .getFloat("last") // Get the `Float` value associated to the `last` key
  .multiply(10 ** 6) // Use 6 digit precision
  .round() // Cast to integer

// Retrieve FET/USDT-6 price from Coinbase
...
// Retrieves USDT price of FET from the HOTBIT API
const hotbit = new Witnet.Source("https://api.hotbit.io/api/v1/market.last?market=FETUSDT")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
