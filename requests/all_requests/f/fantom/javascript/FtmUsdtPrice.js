...
const binance = new Witnet.Source("https://api.binance.us/api/v3/ticker/price?symbol=FTMUSDT")
  .parseJSONMap()
  .getFloat("price")
  .multiply(10 ** 6)
  .round()

// Retrieves FTM/USDT-6 from KUCOIN API
...
// Retrieves USDT price of FTM from the Gate.io API
...
// Retrieves USDT price of FTM from the OkEx API (derived from USDT/USD exchange rate)
const okex = new Witnet.Source("https://www.okex.com/api/index/v3/FTM-USDT/constituents")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
...
// Retrieves FTM/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves FTM/USDT price from the HUOBI API
...
// Retrieves FTM/USDT-6 price from the Bitmax API
