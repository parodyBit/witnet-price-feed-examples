...
// Retrieves FSW/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves USDT price of FSW from the HOTBIT API
const hotbit = new Witnet.Source("https://api.hotbit.io/api/v1/market.last?market=FSWUSDT")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
