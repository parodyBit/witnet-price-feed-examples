...
// Retrieves GOG/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves USDT price of GOG from the OkEx API (derived from USDT/USD exchange rate)
const okex = new Witnet.Source("https://www.okex.com/api/index/v3/GOG-USDT/constituents")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
