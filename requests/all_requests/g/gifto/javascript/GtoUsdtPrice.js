...
// Retrieve GTO/USDT-6 price from the Binance HTTP-GET API
const binance = new Witnet.Source("https://api.binance.us/api/v3/ticker/price?symbol=GTOUSDT")
  .parseJSONMap()
  .getFloat("price")
  .multiply(10 ** 6)
  .round()

// Retrieves GTO/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves USDT price of GTO from the OkEx API (derived from USDT/USD exchange rate)
const okex = new Witnet.Source("https://www.okex.com/api/index/v3/GTO-USDT/constituents")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
