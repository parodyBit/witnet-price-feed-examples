...
// Retrieves USDT price of MTV from the Gate.io API
const gateio = new Witnet.Source("https://data.gateapi.io/api2/1/ticker/mtv_usdt")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
  .getFloat("last") // Get the `Float` value associated to the `last` key
  .multiply(10 ** 6) // Use 6 digit precision
  .round() // Cast to integer

// Retrieves MTV/USDT-6 from KUCOIN API
const kucoin = new Witnet.Source("https://api.kucoin.com/api/v1/market/orderbook/level1?symbol=MTV-USDT")
  .parseJSONMap() 
  .getMap("data")
  .getFloat("price")
  .multiply(10 ** 6)
...
// Retrieves MTV/USDT-6 from the Hoo HTTP-GET API
