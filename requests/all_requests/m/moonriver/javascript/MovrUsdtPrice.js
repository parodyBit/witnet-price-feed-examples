...
// Retrieves USDT price of MOVR from the Gate.io API
...
const binance = new Witnet.Source("https://api.binance.us/api/v3/ticker/price?symbol=MOVRUSDT")
  .parseJSONMap()
  .getFloat("price")
  .multiply(10 ** 6)
  .round()
...
// Retrieves MOVR/USDT-6 from KUCOIN API
...
// Retrieves USDT price of MOVR from the OkEx API (derived from USDT/USD exchange rate)
const okex = new Witnet.Source("https://www.okex.com/api/index/v3/MOVR-USDT/constituents")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
...
// Retrieves MOVR/USDT price from the HUOBI API
const huobi = new Witnet.Source("https://api.huobi.pro/market/detail/merged?symbol=movrusdt")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
