...
// Retrieves MPL/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves MPL/USDT-6 price from the Bitmax API
...
// Retrieves MPL/USDT price from the HUOBI API
const huobi = new Witnet.Source("https://api.huobi.pro/market/detail/merged?symbol=mplusdt")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
