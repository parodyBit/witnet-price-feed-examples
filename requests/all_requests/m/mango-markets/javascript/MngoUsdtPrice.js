...
// Retrieves MNGO/USDT-6 price from the Bitmax API
...
// Retrieves MNGO/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves USDT price of MNGO from the Gate.io API
const gateio = new Witnet.Source("https://data.gateapi.io/api2/1/ticker/mngo_usdt")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
