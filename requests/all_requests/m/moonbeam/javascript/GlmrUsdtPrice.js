...
const binance = new Witnet.Source("https://api.binance.us/api/v3/ticker/price?symbol=GLMRUSDT")
  .parseJSONMap()
  .getFloat("price")
  .multiply(10 ** 6)
  .round()

// Retrieves USDT price of GLMR from the Gate.io API
...
// Retrieves GLMR/USDT price from the HUOBI API
const huobi = new Witnet.Source("https://api.huobi.pro/market/detail/merged?symbol=glmrusdt")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
...
// Retrieves GLMR/USDT-6 from KUCOIN API
...
// Retrieves USDT price of GLMR from the OkEx API (derived from USDT/USD exchange rate)
...
// Retrieves GLMR/USDT-6 from the Hoo HTTP-GET API
