...
// Retrieves MX/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves MX/USDT price from the HUOBI API
const huobi = new Witnet.Source("https://api.huobi.pro/market/detail/merged?symbol=mxusdt")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
