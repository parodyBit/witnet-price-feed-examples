...
// Retrieves LYXE/USDT-6 from KUCOIN API
const kucoin = new Witnet.Source("https://api.kucoin.com/api/v1/market/orderbook/level1?symbol=LYXE-USDT")
  .parseJSONMap() 
  .getMap("data")
  .getFloat("price")
  .multiply(10 ** 6)
...
// Retrieves LYXE/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves USDT price of LYXE from the Gate.io API
const gateio = new Witnet.Source("https://data.gateapi.io/api2/1/ticker/lyxe_usdt")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
