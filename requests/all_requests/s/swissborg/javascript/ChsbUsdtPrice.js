...
// Retrieves CHSB/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves CHSB/USDT price from the HUOBI API
const huobi = new Witnet.Source("https://api.huobi.pro/market/detail/merged?symbol=chsbusdt")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
