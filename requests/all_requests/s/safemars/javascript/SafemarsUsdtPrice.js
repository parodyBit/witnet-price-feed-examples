...
// Retrieves SAFEMARS/USDT-6 from the Hoo HTTP-GET API
    const hoo = new Witnet.Source("https://api.hoolgd.com/open/v1/tickers/market")
      ...
      .filter( 
        ...
        // matches "SAFEMARS-USDT":
        new Witnet.Script([ Witnet.TYPES.MAP ])
          .getString("symbol")
          .match({ "SAFEMARS-USDT": true }, false)
      )
...
// Retrieves USDT price of SAFEMARS from the Gate.io API
const gateio = new Witnet.Source("https://data.gateapi.io/api2/1/ticker/safemars_usdt")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
