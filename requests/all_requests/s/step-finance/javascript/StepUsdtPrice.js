...
// Retrieves STEP/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves USDT price of STEP from the Gate.io API
const gateio = new Witnet.Source("https://data.gateapi.io/api2/1/ticker/step_usdt")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
