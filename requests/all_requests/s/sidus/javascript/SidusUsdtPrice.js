...
// Retrieves SIDUS/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves SIDUS/USDT-6 price from the Bitmax API
...
// Retrieves USDT price of SIDUS from the Gate.io API
const gateio = new Witnet.Source("https://data.gateapi.io/api2/1/ticker/sidus_usdt")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
