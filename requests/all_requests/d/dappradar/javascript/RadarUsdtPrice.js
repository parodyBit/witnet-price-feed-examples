...
// Retrieves RADAR/USDT price from the HUOBI API
const huobi = new Witnet.Source("https://api.huobi.pro/market/detail/merged?symbol=radarusdt")
...
// Retrieves RADAR/USDT-6 from the Hoo HTTP-GET API
