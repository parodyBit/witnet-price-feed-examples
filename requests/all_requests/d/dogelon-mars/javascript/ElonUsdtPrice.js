...
// Retrieves USDT price of ELON from the Gate.io API
...
// Retrieves ELON/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves ELON/USDT-6 from KUCOIN API
...
// Retrieves USDT price of ELON from the OkEx API (derived from USDT/USD exchange rate)
const okex = new Witnet.Source("https://www.okex.com/api/index/v3/ELON-USDT/constituents")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
...
// Retrieves ELON/USDT price from the HUOBI API
...
// Retrieves USDT price of ELON from the HOTBIT API
const hotbit = new Witnet.Source("https://api.hotbit.io/api/v1/market.last?market=ELONUSDT")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
