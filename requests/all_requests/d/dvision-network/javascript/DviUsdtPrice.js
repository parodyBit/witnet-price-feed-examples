...
// Retrieves DVI/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves USDT price of DVI from the Gate.io API
const gateio = new Witnet.Source("https://data.gateapi.io/api2/1/ticker/dvi_usdt")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
