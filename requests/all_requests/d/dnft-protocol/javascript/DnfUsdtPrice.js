...
// Retrieves DNF/USDT-6 from the Hoo HTTP-GET API
...
// Retrieves USDT price of DNF from the HOTBIT API
const hotbit = new Witnet.Source("https://api.hotbit.io/api/v1/market.last?market=DNFUSDT")
  .parseJSONMap() // Parse a `Map` from the retrieved `String`
